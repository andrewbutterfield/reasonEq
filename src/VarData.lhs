...
\begin{code}
addAbstractVarList :: MonadFail m 
                   => Variable -> VarTable -> m VarTable
...
mkPredIntro :: Identifier -> Type -> VarTable -> VarTable
mkPredIntro i t = mkKnownVar (mkPredVar i t) t
