...
This builtin theory defines the alphabet, and signature of a generic ``While''
languages including skip, assignment, sequencing, conditional and while loop.

\textbf{ALL BELOW TO BE STRIPPED DOWN}
