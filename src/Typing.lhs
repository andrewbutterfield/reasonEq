...
addVarType vts (fis,env) v@(Vbl n _ _)
  = case lookupVarTables vts v of
      KnownConst trm ->  foldl (addVarType vts) (fis,env) (getVars trm)           
...
\includegraphics[scale=0.5]{doc/images/TI-ELit}
...
\includegraphics[scale=0.5]{doc/images/TI-EApp}
...
while $A_1,\dots,A_5$ were generated by \h{addVarType}.
