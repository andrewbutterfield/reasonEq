...
\end{code}
We will choose to use a single underscore as the fixed prefix,
...
newTyVar fis = newTypeVariable fis "_"
\end{code}
...
while ${-}_1{},\dots,{-}_5{}$ were generated by \h{buildTypeEnv}.
The issue is that inferred type for the candidate uses ${-}_3{}$  
which then doesn't match the use of $t$ in the pattern.
However, $t$ and ${-}_3{}$ (and ${-}_2{}$) are basically the same.
