...
partsP=(∃ x$,y$  • (x$=e$) ∧ P)
replP=(∃ y$  • P[e$/x$])
tC=ls_1 = ls \ R1 ∪ N1 ∧ ((E1 ⊆ ls ∧ a[O$_1/O$']) ∧ ((E2 ⊆ ls_1 ∧ b[O$_1/O$]) ∧ ls' = ls_1 \ R2 ∪ N2))
scC=O$,O$'∉E1, O$,O$'∉E2, O$,O$'∉N1, O$,O$'∉N2, O$,O$'∉R1, O$,O$'∉R2, s,s'⊇ₐa, s,s'⊇ₐb, fresh:O$_1
---
bindLVarSubstRepl(static): already bound differently.
lv = (Id "x" 0,VO,[],[])
vc1 = BX [Right (V (TC (Id "P" 0) [TG (Id "LE" 0)]) (VR (Id "ls" 0,VO,WD "1")))]
vc2 = BS (fromList [])
bind:
