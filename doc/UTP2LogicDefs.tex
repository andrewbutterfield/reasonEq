...
\def\CJAndOrNAbsN{\QNAME{$\land$-$\lor$-absorb}}
\def\CJOrAndNAbsN{\QNAME{$\lor$-$\land$-absorb}}
...
\def\CJReplN{\QNAME{$\equiv$-replace}}
...
\def\CJRepl{(P\equiv Q) \land (R \equiv P) \equiv (P\equiv Q) \land (R\land Q)}
