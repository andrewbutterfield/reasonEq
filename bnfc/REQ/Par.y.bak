...
%token
  ...
  'DclVar'     { PT _ (TS _ 28)     }
  'Exp'        { PT _ (TS _ 29)     }
  'ExprVars'   { PT _ (TS _ 30)     }
  'Law'        { PT _ (TS _ 31)     }
  'NA'         { PT _ (TS _ 32)     }
  'NS'         { PT _ (TS _ 33)     }
  'Obs'        { PT _ (TS _ 34)     }
  'ObsVars'    { PT _ (TS _ 35)     }
  'Prd'        { PT _ (TS _ 36)     }
  'PredVars'   { PT _ (TS _ 37)     }
  'SB'         { PT _ (TS _ 38)     }
  'SC'         { PT _ (TS _ 39)     }
  'StaticVars' { PT _ (TS _ 40)     }
  'Sub'        { PT _ (TS _ 41)     }
  'SubL'       { PT _ (TS _ 42)     }
  'SubV'       { PT _ (TS _ 43)     }
  'Theory'     { PT _ (TS _ 44)     }
...
Trm7
  ...
  | Trm7 'div' Trm8 { REQ.Abs.EDiv $1 $3 }
  | Trm7 'mod' Trm8 { REQ.Abs.EMod $1 $3 }
  | 'neg' Trm8 { REQ.Abs.ENeg $2 }
  | Trm8 { $1 }
