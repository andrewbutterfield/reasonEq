...
\begin{code}
addKnownVar :: MonadFail m => Variable -> Type -> VarTable -> m VarTable
\end{code}
...
\begin{code}
addGenericVar :: MonadFail m => Variable -> VarTable -> m VarTable
\end{code}
...
\begin{code}
addInstanceVar :: MonadFail m => Variable -> Variable -> VarTable -> m VarTable
\end{code}
...
\begin{code}
addKnownVarList :: MonadFail m => Variable -> VarList -> VarTable -> m VarTable
\end{code}
...
\begin{code}
addKnownVarSet :: MonadFail m => Variable -> VarSet -> VarTable -> m VarTable
\end{code}
...
\begin{code}
addAbstractVarList :: MonadFail m => Variable -> VarTable -> m VarTable
...
\begin{code}
addAbstractVarSet :: MonadFail m => Variable -> VarTable -> m VarTable
...
as being erroneous.
\begin{code}
expandKnown :: MonadFail m => [VarTable] -> ListVar -> m KnownExpansion
